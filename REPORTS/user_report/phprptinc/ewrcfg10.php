...
define("EWR_PROJECT_ID", "{e076bf17-72b6-42b0-900b-e8c36042bfb6}", TRUE); // Project ID
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "", "db" => "the_bliss", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'TnxqOolCZ8wZlMYN', TRUE); // Random key for encryption
