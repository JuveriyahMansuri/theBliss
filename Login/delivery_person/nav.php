...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 style="color:white;" class="fs-2 m-0">Dashboard</h2>
                </div>
                ...
                <div class="navbar-collapse collapse show" id="navbarSupportedContent" style="color:white;" align="right">
                    <ul  class="navbar-nav ms-auto mb-2 mb-lg-0" style="background-color:teal;">
                        <li style="color:white;">
                     <?php 


                        ?>
                         <a height="15px" style="background-color:teal;" width="15px" href="/Login/login.php" class="list-group-item list-group-item-action bg-transparent text-danger fw-bold" onclick="return confirm('Are you sure you want to Log Out?')">
                            ...
                            <?php  } } ?>
                            <i  style="color:white; background-color:teal;"><?php echo $username; ?></i>
                            </a>
