...
if(isset($_POST['n']))
{
  ...
  $q3="UPDATE product_category SET category_name='$cname',sub_category_id='$sname' WHERE product_category_id='$pid'";
...
{
?>
<div class="alert alert-primary" role="alert" align="center"> SUB-CATEGORY UPDATED SUCCESSFULLY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <button type="button"onClick="Javascript:window.location.href = 'edit_p_cat.php';" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>
<?php
