        ...
        <div class="container-fluid">
            <div class="row">
                ...
                if($username!=null)
                    ...
                    echo "Welcome anonymous"?> </strong></li>
  ...
  if (confirm("Are You Sure You Want to Logout!")) {
    ...
    <div id="slides-shop" class="cover-slides">
        <ul class="slides-container">
            <li class="text-left">
                <img src="image/slide11.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> The Bliss</strong></h1>
        ...
        <div class="container">
           ...
           <!-- <img class="img-fluid" src="image/new.jpg" alt="" />-->
                    ...
                    <div class="shop-cat-box">
                        <img  src="image/bakery.jpg" alt=""  width="300px" height="300px"/>
                        <a class="btn hvr-hover" href="shop.php"> Bakery </a>
                    </div>
                    
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img src="image/gift.jpg" alt="" width="300px" height="300px" />
                        <a class="btn hvr-hover" href="shop.php">Hand-made-gifts</a>
                    </div>  
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img  src="image/snacks.jpg" alt="" width="300px" height="300px" />
                        <a class="btn hvr-hover" href="shop.php">Snacks</a>
                    </div>
                </div>
            </div>
        </div>
