                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                    <div class="row" id="row">
                                        <?php 
                                            $query = "SELECT * FROM Product WHERE `p_status` = '1';";
                                                        ...
                                                        <div class="products-single fix">
                                                            <div class="box-img-hover">
                                                               ...
                                                               <img src="image/Project_images/<?php echo $row['display_picture']; ?>" class="img-fluid" alt="Image" height = "200px" width = "200px">
                                                                <div class="mask-icon">
                                                                    <ul>
                                                                        <li> <a href="shop-detail.php?$pname=<?php echo $row['name'];?>" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
                                                                    </ul>
                                                                    <?php 
                                                                    if($username == NULL){ ?>
                                                                        <a class="cart" id="<?php echo $row['product_id'];?>" href="#" onclick="showModal()"><img src="image/cart_logo.png" height="30px" width="30px"> Add to Cart</a>
                                                                    <?php
                                                                    }
                                                                    else{ ?>
                                                                         <a class="cart" id="<?php echo $row['product_id'];?>" href="#" onclick="addProduct(this.id)"> <img src="image/cart_logo.png" height="30px" width="30px"> Add to Cart</a>
                                                                    <?php
                                                                    }
                                                                    ?> 
                                                ...
                                                <div class="why-text full-width">
                                                    ...
                                                    <?php 
                                                                    if($username==null OR $username=='root'){ ?>
                                                                        <a class="btn hvr-hover"  id="<?php echo $row['product_id'];?>" href="#" onclick="showModal()"> <img src="image/cart_logo.png" height="25px" width="30px"> Add to Cart</a>

                                                                    <?php 
                                                                    
                                                                    }
                                                                    else{ ?>
                                                                        <a class="btn hvr-hover"  id="<?php echo $row['product_id'];?>" href="#" onclick="addProduct(this.id)"> <img src="image/cart_logo.png" height="25px" width="30px"> Add to Cart</a>
                                                                    <?php
                                                                    }
                                                                    ?> 
