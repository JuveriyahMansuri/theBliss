...
<head>
    ...
    <!-- Site Metas -->
    <title>The Bliss About - Ecommerce Website</title>
  ...
  if (confirm("Are You Sure You Want to Logout!")) {
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h2 class="noo-sh-title">We are <span>The Bliss</span></h2>
                <p>The Bliss is a platform for unregistered businesses  where they can expand their scope of business.
Here, customers can find vendors (i.e. home bakers,  Decorators, Snacks maker, handmade gift makers individually), buy the products or plan a small event/party. <p>
              <p>
                        </p>
                </div>
                <div class="col-lg-6">
