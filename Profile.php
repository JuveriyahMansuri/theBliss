...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql1 = "UPDATE `User` SET `user_name` = '$username' , `email_address` = '$email' , `mobile` = '$mobile' , `addr` = '$address' , `area_pincode` = '$area_pincode' WHERE `user_id` = '$uid';";
    $res1 = mysqli_query($con, $sql1);
    $sql2 = "UPDATE `Login` SET `username` = '$username' WHERE `user_id` = '$uid';";
...
function fun() {
  if (confirm("Are You Sure You Want to Logout!")) {
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="attr-nav">
                    <ul>
                        ...
                        $result = mysqli_query($con,"SELECT COUNT(*) FROM Cart WHERE user_id = '$uid';");
            ...
            <div class="side">
                ...
                <ul class="cart-list">
                    <?php 
                    /*$t = "SELECT SUM(price) FROM Product WHERE product_id IN (SELECT product_id FROM Cart WHERE user_id = $uid);";
    ...
    <!-- End Top Search -->
      ...
      <form method = "POST" >     
    <center>   
  <!--  <a href="index.php"> <img width=200 height=200 src="Logo.jpg" class="logo" alt=""></a>  add ur logo --> 
        <table>
            <tr> 
       <td> 
            <label for="username">Username</label> </td> 
           <td> <input type="text" name="username" id="username" value="<?php echo $username; ?>" class="form-control"> <br/>
    </td>
 </tr>
    ...
    <tr> 
       ...
       <td> <input type="Email" placeholder="Email ID" name="email" value="<?php echo $row['email_address']; ?>" ><br/> &nbsp
        </td> </tr>

        <tr> 
       <td> 
       <label for="Mobile">Mobile No.:</label> </td>
       <td> <input type="tel" placeholder="Phone Number" name="mobile" value="<?php echo $row['mobile']; ?>" > <br/> &nbsp
        </td> </tr>

        <tr> 
       <td> 
       <label for="Address">Address</label></td> 
       <td>  <textarea placeholder="Enter Address" name="addr"  > <?php echo $row['addr']; ?> </textarea> <br/>  &nbsp 
        </td> </tr>
        <tr>
        <td> 
       <label for="Pincode">Pincode</label></td> 
       <td>  <input placeholder="pincode" name="pincode" value="<?php echo $row['area_pincode']; ?>  "><br/>  &nbsp 
        </td> </tr>
        
         <tr>
        <td>
        <button  type= "cancel" style="float: left;margin: 1px 0 0 1.2%;">CANCEL</button>  </td>
        
        <td>
        <button type="submit" name="done" style="float: right;margin:1px 18.2% 0 0;" >UPDATE</button>  </td> 
</tr> 

<tr> <td> <br/>
    <button >
<a href="change-password.php"> Change-password </a> </button> </td> </tr>
        <br/><br/>
        <br/><br/>
