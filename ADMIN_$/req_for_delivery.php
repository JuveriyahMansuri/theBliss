...
<!-- this is the main content place holder -->
            <div class="container-fluid px-4">
                ...
                <div class="card shadow">
                        ...
                        <center> <p class="text-primary m-0 font-weight-bold"><h3>Assign Delivery of Order <?php echo $oi;?></h3></p> </center>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            <?php
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $oid=$_GET['oid'];
    $amt=$_POST['amt'];
    $s3=mysqli_query($conn,"SELECT * FROM user");
    while($r3=mysqli_fetch_array($s3))
    {
        $pick_up_pincode=$r3['area_pincode'];
    }
    $q4="INSERT INTO request_delivery (amount,delivery_person_id,order_id) VALUES ($amt,$delivery_person_id,$oid)";
