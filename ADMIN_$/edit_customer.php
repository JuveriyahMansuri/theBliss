...
$q1="SELECT u.user_id,u.user_name,u.email_address,u.mobile,u.addr FROM user AS u WHERE u.user_id=".$_GET['cid'];
...
$q2="UPDATE user SET user_name='$user_name',email_address='$email_address',mobile=$mobile,addr='$addr' WHERE user_id=".$_GET['cid'];
$s2=mysqli_query($conn,$q2);

header("location: \Login\ADMIN_$\customer.php");
}
...
<!-- this is the main content place holder -->
            <div class="container-fluid px-4">
                ...
                <div class="card shadow">
                        ...
                        <center> <p class="text-primary m-0 font-weight-bold" d ><h3>Edit Customer</h3></p> </center>
                        </div>
                        <div class="card-body">
