...
include 'con12.php';
    ...
    $sql=mysqli_query($conn,"SELECT * FROM product_category WHERE sub_category_id IS NULL;");
            ...
            <div class="container-fluid px-4">
                <!-- write code from here -->
                    ...
                    <div class="card shadow">
                        ...
                        <center> <p class="text-primary m-0 font-weight-bold"><h3>Product Category</h3></p> </center>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <br> <br><table class="table dataTable my-0" id="dataTable">
                                    <thead>
                                        <tr align="center">
                                            ...
                                            <th>      <center> <a href='add_p_cat.php' style="background-color:grey;" class="btn btn-primary">&#43; </a></center>  </th>
                                            <th>    </th>
                                            <th>  </th>
...
$i=0;
 ...
 { ?>
        ...
        <td align="center" required pattern="[0-9]{10}" style="text-transform:capitalize;"><?php echo $rows['category_name']; ?></td>
        
        <td> <center> <a  href='update.php?pro_cat=<?php echo $rows["product_category_id"]; ?>' style="background-color:grey;" class="btn btn-primary">&#9999;</a></center>  </td>
      <td> <center>  <a href = 'view_main_category.php?action=delete&pc=<?php echo $rows["product_category_id"];  ?>' style="background-color:grey;" class="btn btn-primary" onclick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash"></i>   </a></center></td>
