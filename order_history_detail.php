                    ...
                    <div class="table-main table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $oid = $_GET['$oid'];
                                //echo $oid;
                                $sql = "SELECT o.order_id,o.order_date,o.total_amount,o.order_status,o.delivery_date,od.product_id,od.quantity,od.discount_price,od.price FROM `order` o , `order_detail` od WHERE o.order_id = '$oid' AND o.order_id = od.order_id ORDER BY order_date DESC;";
                            ...
                            <td class="name-pr" align="center">
                                    ...
                                    <a href="#"> <?php $pid = $row['product_id'];
                                     ...
                                     <td class="name-pr">
                                        <a href="#"> <?php $pid = $row['product_id'];
                                            $product = mysqli_query($con,"SELECT `name`,`price`,`replaceable` FROM product WHERE product_id = '$pid';");
                                            $pro = mysqli_fetch_array($product);
                                            $nm = $pro['name'];
                                            //$pr = $pro['price'];
                                            $replacable = $pro['replaceable'];
                                            echo $nm; ?>
								</a>
                                    </td>
                                ...
                                $discount = $row['discount_price'] * $row['quantity'];
                                
                                 echo $t = ( $row['price'] * $row['quantity'] )  - $discount;?> </p> </td>
                                <?php $total = $total + $t; ?>
                                ...
                                <td align="center">
                                    ...
                                    if($now < $deldate AND $replacable==1)
                                    {
                                        $replace = mysqli_query($con,"SELECT `order_id` FROM `order_replace`;");
                                        while($replaceid = mysqli_fetch_assoc($replace)){
                                            $replaceid = $replaceid['order_id'];   
                                            if($oid == $replaceid){
                                                $flag =1;
                                                break;
                                            }
                                            ...
                                            if($flag == 0){
                                            ?>
                                            <button style ="color:white; font-weight:bold;"  onclick = "Javascript:window.location.href = 'order_replace.php?$oid=<?php echo $row['order_id'];?> && $pid=<?php echo $row['product_id'];?>';" class="btn hvr-hover"   type="submit" name="submit" class="btn btn-primary"> Replace </button>
                                    <?php  }
                        ...
                        <br/> <br/>
                        <strong> <p style="color:black;" >Total amount :    <?php echo "₹ ". $total;?> </strong> 
                        &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;  &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                        &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;  &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                        &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                        &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                        &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                        &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                        <button style ="color:white; font-weight:bold;" class="btn hvr-hover" onclick ="Javascript:window.location.href = 'new_invoice.php?$oid=<?php echo $oid;?>';" type="submit" name="submit" class="btn btn-primary"> Invoice </button>
                        </p> 
                    </div>
                </div>
            </div>
