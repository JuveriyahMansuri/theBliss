...
{ 
                     $o1=$rows1['order_id'];  
                     $q2="SELECT o.delivery_status,o.delivery_date,o.order_id,o.requested,o.area_pincode,o.order_date,o.delivery_date,o.delivery_address,o.delivery_status,o.payment_mode,o.order_status,o.cancellation_date,o.total_amount,u.user_name,a.area_name FROM `order` AS o INNER JOIN user AS u ON u.user_id=o.customer_id INNER JOIN area AS a ON a.pincode=o.area_pincode WHERE o.order_id=$o1 ";  
